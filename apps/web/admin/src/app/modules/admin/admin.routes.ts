...
export const ADMIN_ROUTES: Routes = [
  ...
  { 
    ...
    loadComponent: () => import('./components/salon-approval/salon-approval.component')
      .then(m => m.SalonApprovalComponent),
    canActivate: [authGuard],
    data: { roles: ['admin'] }
  },
  { 
    path: 'settings', 
    loadComponent: () => import('./components/system-settings/system-settings.component')
