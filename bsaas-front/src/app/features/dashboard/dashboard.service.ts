...
import { Renewal, DashboardStats, RevenueData, ProductSales, SubscriptionData, BookingTrend } from '../../models/dashboard.model';
...
export class DashboardService {
  ...
  getBookingTrends(): Observable<BookingTrend[]> {
    return this.http.get<{ data: BookingTrend[] }>(`${environment.apiUrl}/dashboard/bookings/trends`).pipe(
      map((response) => response.data || []),
      catchError((error) => {
