...
export class BookingCreateComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    setTimeout(() => {
      ...
      this.snackBar.open(this.translate.instant('BOOKING.CREATE_SUCCESS'), this.translate.instant('COMMON.CLOSE'), { duration: 5000 });

      // Navigate to booking list or confirmation page
