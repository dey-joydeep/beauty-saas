...
describe('ReviewController (e2e)', () => {
  ...
  describe('POST /reviews', () => {
    it('should create a review', async () => {
      ...
      const response = await createRequest('post', '/reviews')
        .send(createDto)
        .expect(201);
  ...
  describe('GET /reviews', () => {
    it('should return an array of reviews', async () => {
      const response = await createRequest('get', '/reviews')
        .expect(200);
  ...
  describe('GET /reviews/:id', () => {
    it('should return a review by ID', async () => {
      const response = await createRequest('get', `/reviews/${mockReview.id}`)
        .expect(200);
  ...
  describe('PUT /reviews/:id', () => {
    it('should update a review', async () => {
      ...
      const response = await createRequest('put', `/reviews/${mockReview.id}`)
        .send(updateDto)
        .expect(200);
  ...
  describe('DELETE /reviews/:id', () => {
    it('should delete a review', async () => {
      const response = await createRequest('delete', `/reviews/${mockReview.id}`)
        .expect(200);
  ...
  describe('POST /reviews/:id/respond', () => {
    it('should add a response to a review', async () => {
      ...
      const response = await createRequest('post', `/reviews/${mockReview.id}/respond`)
