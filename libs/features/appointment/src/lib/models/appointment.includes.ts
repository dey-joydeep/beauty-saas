...
import { CUSTOMER_SELECT, SALON_SELECT, TENANT_PRODUCT_SELECT, TENANT_SERVICE_SELECT } from './appointment.model';
import { UserWithMinimalInfo } from './user-params.model';
